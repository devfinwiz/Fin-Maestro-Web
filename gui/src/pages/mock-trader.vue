  ...
  methods: {
            ...
            this.trades.push(
              {
                id: v[1],
                tickerName: v[2],
                type: v[3], // 1 is buy 2 is sell
                enterPrice: v[4],
                exitPrice: v[5],
                isOpen: v[6] == "1" ? true : false,
              }
            )
          })
        }
    ...
    wrapTrade: function(trade) {
      if (trade.isOpen) {
        ...
        axios.get(ENDPOINTS.exitTrade + "/" + trade.id + "/" + trade.tickerName + "/" + trade.exitPrice).then((r) => {console.log("exited trade")})
      }
    },
